...
def evaluateInput(message, encoder, decoder, searcher, voc):
    print('Evaluating: "{}" ...'.format(message.content))
    input_sentence = ''
    while(1):
        try:
            # Get input sentence
            ...
            if newInput == 'q' or input_sentence == 'quit': 
                ...
                break
            # Normalize sentence
            newInput = normalizeString(newInput)
            print('Normalized string: "{}" ...'.format(newInput))
            # Evaluate sentence
            output_words = evaluate(encoder, decoder, searcher, voc, newInput)
